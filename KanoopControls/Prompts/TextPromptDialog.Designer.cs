namespace KanoopControls.Prompts
{
	partial class TextPromptDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.textReply = new System.Windows.Forms.RichTextBox();
			this.SuspendLayout();
			// 
			// btnOK
			// 
			...
			this.btnCancel.Location = new System.Drawing.Point(322, 41);
			...
			// textReply
			// 
			this.textReply.Location = new System.Drawing.Point(13, 12);
			this.textReply.Name = "textReply";
			this.textReply.Size = new System.Drawing.Size(293, 238);
			this.textReply.TabIndex = 0;
			this.textReply.Text = "";
			this.textReply.TextChanged += new System.EventHandler(this.OnTextChanged);
			// 
			// TextPromptDialog
			// 
		...
		private System.Windows.Forms.RichTextBox textReply;
	}
}