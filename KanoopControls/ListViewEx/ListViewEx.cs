...
namespace CommonControls
{
	...
	public class ListViewEx	: System.Windows.Forms.ListView
	{
		...
		public bool CurrentlyEditing { get; private set; }
	...
	public class SubItemEndEditingEventArgs : SubItemEventArgs
	{
		...
		public SubItemEndEditingEventArgs(ListViewItem item, int subItem, string display, bool cancel, Control editingControl) 
			: base(item, subItem)
		{
			_text = display;
			_cancel = cancel;
